...
5. **US-only location:** `fillLocation` must never confirm a foreign row (same 5-digit ZIP exists abroad). It prefers US, retries with a "United States" hint, and fails rather than posting abroad.
